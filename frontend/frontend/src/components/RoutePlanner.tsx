...
function RoutePlanner() {
    ...
    const generateRoute = async () => {
        try {
            ...
            if (!trip) {
                console.error("Trip data missing:", data);
                setIsAnimating(false);
                return;
            }
            ...
            const formattedRoute: RouteData = {
                ...
                geometry: trip.geometry.coordinates[0],
    ...
    return (
        <div className={`app ${routeGenerated ? "route-mode" : ""}`}>
            {!routeGenerated && (
            ...
            {routeGenerated && routeData && (
                <div className="route-info">
                    ...
                    <p>
                        Duration: {routeData.total_driving_hours} hours
                    </p>

                    <p>
                        Stops: {routeData.markers.length}
                    </p>
                </div>
            )}
        </div>
